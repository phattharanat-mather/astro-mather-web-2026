...
image: "./images/qr-snow-village.png"
---

import qrSnow from './images/qr-snow-village.png';
import qrAnime from './images/qr-anime.png';
...
<img src={qrSnow.src} alt="A snowy alpine village scene where the buildings form a scannable QR code" style="border-radius: 8px; margin: 2rem 0;" />
...
<img src={qrAnime.src} alt="An anime-style illustration with flowing ribbons where the composition encodes a QR code" style="border-radius: 8px; margin: 2rem 0;" />
